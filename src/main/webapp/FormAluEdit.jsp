...
<html>
    ...
    <form class="form-horizontal" action="ControllerAluno.jsp" >
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="tf_registro" name="tf_registro" type="text" value="<%=request.getParameter("tf_registro")%>"  class="form-control input-md" required="">
                     ...
                     <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label" for="tf_idade">Idade</label>  
                <div class="col-md-4">
                    <input id="tf_idade" name="tf_idade" type="text" value="<%=request.getParameter("tf_idade")%>"  class="form-control input-md" required="">
