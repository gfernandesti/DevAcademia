    ...
    <form class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <button id="bt_enviar" name="bt_enviar" class="btn btn-primary">Enviar</button>
                    <button id="bt_cancelar" name="bt_cancelar" class="btn btn-primary">Cancelar</button>
                </div>
            </div>
