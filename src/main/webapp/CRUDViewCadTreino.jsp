...
<%
    ...
    for(Treino tre:lista.getLista()){
        ...
        exercicio=tre.getExercicio();
        sequencia=tre.getSequencia();
        dia=tre.getDia(); 
        %>
...
<td><a href="FormTreinoEdit.jsp?tf_id=<%=id%>&tf_sequencia=<%=sequencia%>&tf_descricao=<%=aluno%>" class=" btn btn-info">Alterar</a></td>
</tr>
<%}%>
